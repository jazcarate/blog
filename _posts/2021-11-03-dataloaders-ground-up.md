...
Rather than waiting, we are fetching the information and then waiting to _return_ it to whatever dependency of the defer. That would yield a code like this:
```kotlin
